...
import { useGetUserCart, useGetUserSavedProducts } from "../../../hooks/user";
import { User } from "../../../types/user";
import GridObjectNotFound from "../../../components/common/object-not-found/GridObjectNotFound";

const UserAccountSavedProducts = () => {
  const context = useOutletContext<User>();
  const { data, isLoading, error, refetch } = useGetUserSavedProducts({
    userId: context._id,
  });
  ...
  return (
    ...
    >
      ...
      >
        ...
        {data?.savedProducts.map((product) => (
...
export default UserAccountSavedProducts;
